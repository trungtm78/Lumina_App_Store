  ...
  try {
    ...
    return (
      <div className="max-w-5xl mx-auto px-6 py-16 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700">App không tồn tại</h2>
    ...
    <div className="max-w-5xl mx-auto px-6 py-6">
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl font-bold text-gray-900" title={app.name}>
            {displayName}
          </h1>
          ...
          <div className="mt-8">
            <h2 className="text-lg font-semibold text-gray-800">Có gì mới</h2>
        ...
        <aside className="w-72 flex-shrink-0">
          <div className="bg-white border border-gray-200 rounded-xl p-5 sticky top-6">
            ...
            <div className="flex justify-center mb-4">
              <div
                className="bg-gray-200 rounded-xl flex items-center justify-center text-gray-500 font-bold"
            ...
            <div className="mt-5 space-y-3 text-sm">
              ...
              <div>
                <span className="text-gray-500">Phiên bản tối thiểu:</span>
                <p className="text-gray-800">{app.min_version || "—"}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800">{app.download_count.toLocaleString()}</p>
              </div>
